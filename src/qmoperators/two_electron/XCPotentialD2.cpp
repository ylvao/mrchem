...
FunctionTree<3> *XCPotentialD2::buildComponentGamma(int orbital_spin, int density_spin, FunctionTree<3> &pert_dens) {
    ...
    */
    ...
    mrcpp::build_grid(*sum_42, *div4);
    mrcpp::build_grid(*sum_42, *div2);
