 ...
 */
XCHessian::XCHessian(mrdft::XCFunctional *F, OrbitalVector *Phi)
        : QMPotential(1),
          orbitals(Phi),
          functional(F) {
}
 ...
 *
 */
void XCHessian::setup(double prec) {
 ...
 *
 */
void XCHessian::setupPotential(double prec) {
 ...
 */
Density &XCHessian::getDensity(int spin) {
 ...
 */
FunctionTree<3>& XCHessian::getPotential(int spin) {
 ...
 */
Orbital XCHessian::apply(Orbital phi) {
