...
KineticOperator::KineticOperator(DerivativeOperator<3> &d_oper)
        : QMOperator() {
    this->p_x = new MomentumOperator(0, d_oper);
    this->p_y = new MomentumOperator(1, d_oper);
    this->p_z = new MomentumOperator(2, d_oper);
}
